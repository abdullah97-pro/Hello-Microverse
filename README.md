...
> Here is a Hello Microverse Project showcasing. it has HTML and CSS also configured the (Linters) ability for error detecting and formatting the codes
...
```sh
  cd my-folder
  git https://github.com/abdullah97-pro/Hello-Microverse
```
<!-- INSTALL -->
